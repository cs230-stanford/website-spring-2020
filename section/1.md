...
Your project will be done in groups of 1 to 3 students (4 with TA approval), and has the following steps:
  ...
  - [Milestone 1](/project/#milestone-1) (Due {{ site.course.project_timeline.milestone1 | date: site.course.project_timeline.long_date_format }})
  - [Milestone 2](/project/#milestone-2) (Due {{ site.course.project_timeline.milestone2 | date: site.course.project_timeline.long_date_format }})  
